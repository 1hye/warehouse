...
| Cursor IDE 已安装 | 打开 Cursor IDE | 版本要求：最新稳定版 |
...
# 验证模板文件已就绪
ls -la
# 应该看到：.cursor/  harness-collab/  config/  pom.xml  README.md  AGENTS.md
```
...
```bash
# 验证关键目录和文件存在
ls .cursor/rules/     # 应该看到 5 个 .mdc 文件
ls .cursor/hooks/     # 应该看到 1 个脚本文件
...
```
=== Harness 模板完整性验证 ===
✅ .cursor/rules/java-engineering-standards.mdc
✅ .cursor/rules/testing-quality-standards.mdc
✅ .cursor/rules/api-doc-sync-protocol.mdc
✅ .cursor/rules/ai-collaboration-protocol.mdc
✅ .cursor/rules/project-lifecycle.mdc
✅ .cursor/hooks.json
✅ .cursor/hooks/harness-reminder.ps1
...
✅ Harness 模板完整性验证通过
```
...
head -5 .cursor/rules/java-engineering-standards.mdc
# 应该看到：
# ---
# inclusion: auto
# ---
