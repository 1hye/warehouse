...
本文档定义 Cursor Agent 与开发者在 Spring Boot Harness 工程管理模板下的完整协作协议。所有使用本模板的项目，Cursor Agent 必须严格遵守本协议中的行为规范和交付标准。
...
Cursor Agent 在本工作区内的所有行为受以下约束层级管控（优先级从高到低）：
...
| 功能状态变更 | `func.md` | 开发者 |
| 架构规则变更 | `05-methodology/architecture-constraints.md`、`.cursor/rules/java-engineering-standards.mdc` | 架构师 |
| 流程变更 | `05-methodology/dev-workflow.md`、`.cursor/rules/project-lifecycle.mdc` | 团队负责人 |
