...
本文档以流程图形式描述 Spring Boot Harness 模板定义的完整研发生命周期（Dev_Lifecycle），供 AI Agent 和开发者在整个开发过程中随时参考。
...
flowchart TD
    ...
    subgraph Phase1["阶段 1：需求分析"]
        P1A[开发者描述功能需求] --> P1B[Agent 引导填写需求文档模板]
    ...
    subgraph Phase2["阶段 2：技术设计"]
        P2A[Agent 基于需求提出技术方案] --> P2B[填写设计文档模板]
...
1. 开发者向 Agent 描述新功能的业务背景和需求
2. Agent 引导开发者使用 `01-product-specs/templates/product-spec-template.md` 模板
...
1. Agent 基于需求文档提出技术方案（架构选型、接口设计、数据模型）
