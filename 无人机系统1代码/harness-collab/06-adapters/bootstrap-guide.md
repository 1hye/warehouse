...
| Trae IDE 已安装 | 打开 Trae IDE | 版本要求：最新稳定版 |
...
# 验证模板文件已就绪
ls -la
# 应该看到：.trae/  harness-collab/  config/  pom.xml  README.md  AGENTS.md
```
...
### 步骤 4：在 Trae IDE 中打开工作区，验证规则文件已加载
...
```
=== Harness 模板完整性验证 ===
✅ .trae/rules/java-engineering-standards.md
✅ .trae/rules/testing-quality-standards.md
✅ .trae/rules/api-doc-sync-protocol.md
✅ .trae/rules/ai-collaboration-protocol.md
✅ .trae/rules/project-lifecycle.md
...
✅ Harness 模板完整性验证通过
```
...
**原因**：可能是工作区根目录选择不正确，或规则文件缺少 `alwaysApply: true` 元数据。

**解决方案**：
```bash
# 确认规则文件包含正确的元数据
head -5 .trae/rules/java-engineering-standards.md
# 应该看到：
# ---
# alwaysApply: true
# ---

# 重新打开工作区（关闭 Trae IDE 后重新打开工作区根目录）
```
